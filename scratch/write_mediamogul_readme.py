readme_text = """# 🎬 MediaMogul - Autonomous AI Video Editor & Shotcut Copilot
...
with open(r"C:\GitHub5\CryptArtistStudio\v2\MediaMogul\README.md", "w", encoding="utf-8") as f:
    f.write(readme_text)

print("MediaMogul README.md created successfully")
